...
class _HealthKitDemoState extends State<HealthKitDemo> {
  ...
  void initDataController() async {
    ...
    try {
      _dataController = await DataController.init(<HiHealthOption>[
        ...
        HiHealthOption(DataType.DT_INSTANTANEOUS_HEART_RATE, AccessType.read),
        HiHealthOption(DataType.DT_INSTANTANEOUS_HEART_RATE, AccessType.write),
  ...
  void insert() async {
    ...
    SampleSet sampleSet = SampleSet(dataCollector, <SamplePoint>[
      SamplePoint(
          startTime: DateTime.parse('2020-10-10 12:11:00'),
          endTime: DateTime.parse('2020-10-10 12:11:00'),
          fieldValueOptions: FieldFloat(Field.FIELD_BPM, 100.0))
    ]);
  ...
  void read() async {
    ...
    ReadOptions readOptions = ReadOptions(
      ...
      startTime: DateTime.parse('2020-12-26 12:10:00'),
      endTime: DateTime.parse('2020-12-27 12:12:00'),
    )..groupByTime(10000);
  ...
  void readDailySummation() async {
    ...
    try {
      SampleSet sampleSet = await _dataController.readDailySummation(
          DataType.DT_INSTANTANEOUS_HEART_RATE, 20201002, 20201215);
  ...
  void readTodaySummation() async {
    ...
    try {
      SampleSet sampleSet = await _dataController
          .readTodaySummation(DataType.DT_INSTANTANEOUS_HEART_RATE);
